 ...
 */
public class ConsultaAlteraFuncionario extends javax.swing.JInternalFrame {

    public ConsultaAlteraFuncionario() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jComboBox2.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Selecione -", "Feminino", "Masculino", "Outros" }));

        jLabel7.setText("DATA DE NASCIMENTO");

        jButton7.setText("REDEFINIR SENHA");
        ...
        jPanel3.setBorder(javax.swing.BorderFactory.createTitledBorder("Ocupação atual do funcionário"));

        jLabel1.setText("OCUPAÇÃO");
        ...
        jPanel4.setBorder(javax.swing.BorderFactory.createTitledBorder("Vendas do Funcionário em questão"));
        ...
        jLabel8.setText("* É necessário clicar em ALTERAR para salvar alterações, caso contrário clique em cancelar.");
